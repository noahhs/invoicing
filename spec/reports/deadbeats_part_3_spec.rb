...
describe Reports::Deadbeats do
  ...
  context "deadbeats report part 3" do
    #subject { Reports::Deadbeats.new }
    #let(:cutoff_date) { 6.months.ago }

    #it "forgives debt older than the given cutoff date" do
    #  subject.generate(csv)

    #  report = csv.drop(1)

    #  report.should == [
    #    ["Beethoven Inc.", Money.new(150_00)],
  ...
  context "deadbeats report part 2 and 3" do
    #subject { Reports::Deadbeats.new }
    #let(:cutoff_date) { 6.months.ago }
    #let(:minimum) { Money.new(10_00) }

    #it "drops debts below the minimum AND older than the given cutoff date" do
    #  subject.generate(csv)
